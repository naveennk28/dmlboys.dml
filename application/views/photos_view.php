                ...
                <div class="img-w">
                    ...
                    <div class="row">
                        <?php foreach ($ans as $key) { ?>
                            <div class="col-sm-4">
                                <img src='<?php echo base_url(); ?>upload/photos/<?php echo $key;?>' class="img-thumbnail rounded-float-left" style="width: 300px;height: 200px"  alt="" />
                                <a href='<?php echo base_url(); ?>upload/photos/<?php echo $key;?>' class="btn btn-sm btn-success btn-link" download>Download</a>
                            </div>
                        <?php } ?>
                    </div>
                </div>
